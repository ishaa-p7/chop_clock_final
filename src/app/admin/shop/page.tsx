              ...
              <CardContent>
                <form className="space-y-6">
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div className="space-y-2">
                      ...
                      <p className="text-xs text-slate-500">
                        A short slogan that describes your shop
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="space-y-2">
                    ...
                    />
                    <p className="text-xs text-slate-500">
                      Detailed description of your barber shop
                    </p>
                  </div>
                  ...
                  <div className="space-y-2">
                    ...
                    />
                    <p className="text-xs text-slate-500">
                      e.g. Mon-Fri: 9AM-7PM, Sat: 9AM-5PM, Sun: Closed
                    </p>
                  </div>
                  ...
                  <div className="bg-white rounded-lg border p-6">
                    ...
                    <div className="flex items-center gap-3">
                      ...
                      <span className="text-slate-500">
                        ({previewData.reviewCount} reviews)
                      </span>
                    </div>
                  </div>
                ) : (
      ...
      <footer className="bg-blue-800 text-white py-8 mt-20">
        <div className="container mx-auto px-4 text-center">
          <p className="text-blue-200">
            © {new Date().getFullYear()} Barber Shop Admin. All rights
            reserved.
          </p>
        </div>
      </footer>
