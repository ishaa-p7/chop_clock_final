  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        ...
        if (!shopResponse.ok)
          throw new Error(shopData.error || 'Failed to load shop details')
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      toast({
        ...
        action: (
          <ToastAction altText="Home" onClick={() => router.push('/')}>
            Go Home
          </ToastAction>
        ),
      })
            ...
            <Card className="sticky top-6">
              ...
              <CardContent className="space-y-4">
                ...
                <div className="space-y-2">
                  ...
                  <p className="text-slate-600">
                    {formData.timeSlot || 'No time selected'}
                  </p>
                </div>
      ...
      <footer className="bg-blue-800 text-white py-8 mt-20">
        <div className="container mx-auto px-4 text-center">
          <p className="text-blue-200">
            © {new Date().getFullYear()} {shop?.name || 'Barber Shop'}. All
            rights reserved.
          </p>
        </div>
      </footer>
