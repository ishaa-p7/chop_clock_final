            ...
            <div className="absolute inset-0 bg-gradient-to-r from-blue-900/70 to-blue-900/40 flex items-center">
              <div className="container mx-auto px-4">
                <div className="max-w-xl">
                  <Badge className="mb-4 bg-blue-500 hover:bg-blue-600">Now Open</Badge>
                  <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-white mb-4">{shop.name}</h1>
        ...
        <section className="py-12 bg-white">
          <div className="container mx-auto px-4">
            <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-6 mb-8">
              <div>
                <h2 className="text-3xl font-bold text-blue-800">Welcome to {shop.name}</h2>
                ...
                <Card>
                  ...
                  <CardContent className="space-y-4">
                    ...
                    <div className="flex items-center gap-2">
                      ...
                      <span className="text-slate-600">{shop.rating} out of 5</span>
                    </div>
                    <p className="text-sm text-slate-500">Based on {shop.reviewCount} customer reviews</p>
                  </CardContent>
                </Card>
              </div>
            </div>
          ...
          <div className="container mx-auto px-4">
            <div className="text-center mb-12">
              ...
              <p className="text-slate-600 max-w-2xl mx-auto">
                We offer a wide range of professional barber services to keep you looking your best. All services
                include a consultation to ensure you get exactly what you want.
              </p>
            </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
              <div>
                ...
                <p className="text-slate-600 mb-8">
                  We're conveniently located in the heart of the city. Drop by for a visit or book your appointment in
                  advance.
                </p>
